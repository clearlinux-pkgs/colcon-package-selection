...
Source0  : https://files.pythonhosted.org/packages/ea/29/23f06cd2cf8f0569f23a5d3ef30e21ef4840fa39be8b3bc26c30d0b3a4f5/colcon-package-selection-0.2.2.tar.gz
...
%prep
%setup -q -n colcon-package-selection-0.2.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1547690540
